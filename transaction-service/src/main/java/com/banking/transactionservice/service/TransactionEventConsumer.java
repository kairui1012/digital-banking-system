...
public class TransactionEventConsumer {
    ...
    public void consumerVerificationRequire(@Payload Map<String, Object> payload){
        try {
            ...
            String otp = String.format("%06",(int)(Math.random() * 900000 )+ 100000);
            ...
            log.info("OTP generated for transaction: {} expires in {} mins",transactionId,OTP_EXPIRY_MINUTES);
    ...
    public void consumeFraudCheckCleanResult(@Payload Map<String,Object> payload){
        try {
            ...
            log.error(
                    "Error processing fraud check result: {}",
                    e.getMessage()
            );
        }
    }
